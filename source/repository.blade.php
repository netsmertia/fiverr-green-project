            ...
            <div class="section-content h-100">
                <div class="row justify-content-center h-100">
                    <div class="col-md-5 d-flex justify-content-center align-items-center">
                        <div class="card ">
                            <div class="card-body">
                                <p class="pt30 mb-0">Librería virtual que servirá de referencia para cualquier persona que quiera ayudar a la comunidad, pero no sepa por dónde empezar. Los proyectos son eventos de NeedMe con más detalles provistos por los coordinadores. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-5 offset-1 center-in-column text-center">
                        <h1 class="pt120 fw-bold mb-1">PRONTO</h1>
